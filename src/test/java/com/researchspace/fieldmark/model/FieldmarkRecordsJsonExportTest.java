...
class FieldmarkRecordsJsonExportTest {
  ...
  @ValueSource(strings = {"rec-5eb53c21-d7f8-41a7-a8b5-4900e46cf8e0",
      "rec-678a0fac-05e1-448c-8e57-61a858fffcfd",
      "rec-b189e6ec-b760-4b44-8789-0ddc35d7cde2", "rec-e881323c-d3cb-4393-9784-07b86585675b"})
  void testAllRecordsAreIngested(String recordId) {
    assertEquals(4, underTest.getRecordsById().size());
  ...
  @ParameterizedTest
  @ValueSource(strings = {"Field-ID", "hridPrimary-Next-Section", "Survey-Number", "IGSN-QR-Code",
      "Sample-Location", "New-Text-Field", "Description", "Sample-Photograph", "Length-mm",
  ...
  void testThrowExceptionIfMultipleFormIDsAreFound() throws IOException {
    String jsonRecords = IOUtils.resourceToString("/json/records_unsupported_multiple_form.json",
        Charset.defaultCharset());
    FieldmarkRecordsJsonExport records = mapper.readValue(jsonRecords,
