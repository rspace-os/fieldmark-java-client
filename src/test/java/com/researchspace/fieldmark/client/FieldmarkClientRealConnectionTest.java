...
class FieldmarkClientRealConnectionTest {
 ...
 @Test
  ...
  public void testGetNotebookRecords() {
    FieldmarkRecordsJsonExport result =  fieldmarkClientImpl.getNotebookRecords(LONG_LIVED_TOKEN, NOTEBOOK_ID);
    assertNotNull(result);
  }

  @Test
  public void testGetNotebookCsv() throws IOException {
    FieldmarkRecordsCsvExport result =  fieldmarkClientImpl.getNotebookCsv(LONG_LIVED_TOKEN, NOTEBOOK_ID, FORM_ID);
    assertNotNull(result.getRecords());
  }

  @Test
  public void testGetNotebookFiles() throws IOException {
    Map<String, byte[]> result =  fieldmarkClientImpl.getNotebookFiles(LONG_LIVED_TOKEN, NOTEBOOK_ID, FORM_ID);
    assertNotNull(result);
  }
